		  ...
		  <ul class="nav navbar-nav">
			...
			<li class="dropdown">
			  ...
			  <ul class="dropdown-menu">
				...
				<li><a onclick="window.open('includes/LaporanAlternatif.php', '_blank')">Laporan Alternatif</a></li>
				<li><a onclick="window.open('includes/LaporanKriteria.php', '_blank')">Laporan Kriteria</a></li>
			  </ul>
			</li>
		  </ul>
