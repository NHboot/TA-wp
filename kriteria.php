...
<form method="post">
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            ...
            <button type="button" onclick="location.href='kriteria-baru.php'" class="btn btn-primary">Tambah
                Data</button>
        </div>
    </div>
    <br />
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tr>
                    ...
                    <td style="text-align:center;vertical-align:middle;">
                        <a href="kriteria-ubah.php?id=<?php echo $row['id_kriteria'] ?>" class="btn btn-warning"><span
