...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-4">
		...
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:#d9534f; border-color:steelblue">
				<h3 class="panel-title" style="color:white">Input Data</h3>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:#d9534f; border-color:steelblue">
				<h3 class="panel-title" style="color:white">Analisa Data</h3>
			</div>
			<div class="panel-body">
				<ul class="nav nav-pills nav-stacked">
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:#d9534f; border-color:steelblue">
				<h3 class="panel-title" style="color:white">Nilai Preferensi</h3>
			</div>
			<div class="panel-body">
				<ol>
					<?php
	...
	<div class="col-xs-12 col-sm-12 col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:#d9534f; border-color:steelblue">
				<h3 class="panel-title" style="color:white">Kriteria-Kriteria</h3>
			</div>
			<div class="panel-body">
				<ol>
					<?php
	...
	<div class="col-xs-12 col-sm-12 col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:#d9534f; border-color:steelblue">
				<h3 class="panel-title" style="color:white">Bobot Kriteria</h3>
			</div>
			<div class="panel-body">
	...
	<div class="col-xs-12 col-sm-12 col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:#d9534f; border-color:steelblue">
				<h3 class="panel-title" style="color:white">Alternatif Produk</h3>
			</div>
			<div class="panel-body">
				<ol>
					<?php
