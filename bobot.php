    ...
    <table width="100%" class="table table-striped table-bordered" id="tabeldata">
        ...
        <tbody>
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ?>
                <tr>
                    <td style="vertical-align:middle;"><input type="checkbox" value="<?php echo $row['id_kriteria'] ?>"
                            name="checkbox[]" /></td>
                    <td style="vertical-align:middle;"><a style="color:#060;"
                            href="kriteria-ubah.php?id=<?php echo $row['id_kriteria'] ?>"><?php echo $row['nama_kriteria'] ?></a>
                    </td>
                    ...
                    <td style="text-align:center;vertical-align:middle;">
                        <a href="bobot-ubah.php?id=<?php echo $row['id_kriteria'] ?>" class="btn btn-warning"><span
                                class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                        <a href="bobot-hapus.php?id=<?php echo $row['id_kriteria'] ?>"
