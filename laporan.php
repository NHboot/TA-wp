...
<body>
	<div id="container" class="container">
		...
		<div>
			...
			<!-- Nav tabs -->
			<form method="POST" action="cetak_nilai.php">
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#rangking" aria-controls="rangking" role="tab"
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="rangking">
					...
					<table width="100%" class="table table-striped table-bordered">
						<thead>
							<tr>
								<th style="vertical-align: middle" class="text-center">Ranking</th>
						...
						<tbody>
							<?php 
							$no = 1;
							while ($row1 = $stmtranking->fetch(PDO::FETCH_ASSOC)) { ?>
								<tr>
								<td><?php echo $no++; ?></td>
						...
						<thead>
							...
							<tr>
								...
								while ($row2x = $stmt2x->fetch(PDO::FETCH_ASSOC)) {
									?>
									<th><?php echo $row2x['nama_kriteria'] ?><br />(<?php echo $row2x['tipe_kriteria'] ?>)
									</th>
									<?php
								}
								?>
